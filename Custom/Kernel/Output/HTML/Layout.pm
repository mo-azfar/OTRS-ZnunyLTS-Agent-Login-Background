...
# Copyright (C) 2021 mo-azfar, https://github.com/mo-azfar/OTRS-ZnunyLTS-Agent-Login-Background
# --
...
sub Login {
    ...
    # ---
    # OTRS-ZnunyLTS-Agent-Login-Background
    # ---
    ...
    if ( defined $ConfigObject->Get('AgentLoginBackground') ) {
        ...
        for my $CSSStatement ( sort keys %AgentLoginBackground ) {
            if ( $CSSStatement eq 'URL' ) {
                ...
                $Data{'URL'} = 'url(' . $WebPath . $AgentLoginBackground{$CSSStatement} . ') no-repeat center';
            }
            else {
